...
import { init_ssg_sandbox_shims as t, window as n } from "./react.Bo_x0BtE.mjs";
import {
  ControlType as r,
  QueryCache as i,
  QueryEngine as a,
  addPropertyControls as o,
  init_framer_QIGYLLGG as s,
...
async function Ie(e) {
  let t = Math.floor(G * (Math.random() + 1) * 2 ** (e - 1));
  await new Promise((e) => {
    setTimeout(e, t);
  });
}
...
` +
      ...
      (N = n !== void 0),
      (Re = N && typeof n.requestIdleCallback == `function`),
      (P = 1024),
      (F = 1.5),
      (I = (e) => 2 ** e - 1),
      (L = (e) => -(2 ** (e - 1))),
      ...
      (V = class {
        ...
        ensureLength(e) {
          ...
          let n = new Uint8Array(Math.ceil(t * F) + e);
          n.set(this.bytes), (this.bytes = n), (this.view = c(n));
        }
        writeUint8(e) {
          d(e, z.Uint8, B.Uint8, `Uint8`);
          let t = j.Uint8;
          this.ensureLength(t),
        ...
        writeUint64(e) {
          d(e, z.Uint64, B.Uint64, `Uint64`);
          let t = BigInt(e);
          this.writeBigUint64(t);
        }
        writeBigUint64(e) {
          d(e, z.BigUint64, B.BigUint64, `BigUint64`);
          let t = j.BigUint64;
          this.ensureLength(t),
        ...
        writeInt64(e) {
          d(e, z.Int64, B.Int64, `Int64`);
          let t = BigInt(e);
          this.writeBigInt64(t);
        }
        writeBigInt64(e) {
          d(e, z.BigInt64, B.BigInt64, `BigInt64`);
          let t = j.BigInt64;
          this.ensureLength(t),
      ...
      (Ve = class {
        async loadModel() {
          ...
          return l(e, `Failed to load model`), U.deserialize(e);
        }
        async getModel() {
          return (
      ...
      (He = class {
        scanItems() {
          return (
            (this.itemsPromise ??= K(this.url).then(async (e) => {
              if (!e.ok)
      ...
      (Ue = class {
        ...
        constructor(e) {
          (this.options = e),
            ...
            O(this, `chunks`),
            (this.chunks = this.options.chunks.map((e, t) => new He(t, e))),
...
var J,
  ...
  qe = e(() => {
    (J = (e, t) => async () => {
      ...
      (Y = () => import(`./kB5JQlUFw-2.Ko3G8Mwk.mjs`)),
      (Ke = [
        J(Y, `richText`),
        J(Y, `richText1`),
        J(Y, `richText2`),
  ...
  Qe = e(() => {
    s(),
      ...
      (X = {
        ...
        OCaOEbNus: { isNullable: !0, type: r.Boolean },
        OLvxZOgor: { isNullable: !0, type: r.String },
        oNC7XILjD: { isNullable: !0, type: r.String },
        previousItemId: { isNullable: !0, type: r.String },
        RnKlzkUAj: { isNullable: !0, type: r.Date },
        tjCVoZ23o: { isNullable: !0, type: r.RichText },
      }),
      (Je = new a()),
      (Z = new i(Je)),
      (Q = {
        collectionByLocaleId: {
          default: new Ue({
            chunks: [
              new URL(
                `./kB5JQlUFw-chunk-default-0.framercms`,
                `framerusercontent.com/modules/zZK5yBClQezmZlJitbIy/w0S33Y2CBNfnkUuMVJCk/kB5JQlUFw.js`
      ...
      (Ye = Q),
      o(Q, {
        OCaOEbNus: { defaultValue: !1, title: `Publish`, type: r.Boolean },
        RnKlzkUAj: { title: `Update date`, type: r.Date },
        OLvxZOgor: { defaultValue: ``, title: `Title`, type: r.String },
        tjCVoZ23o: { defaultValue: ``, title: `Content`, type: r.RichText },
        oNC7XILjD: { title: `Slug`, type: r.String },
        previousItemId: {
          dataIdentifier: `local-module:collection/kB5JQlUFw:default`,
          title: `Previous`,
          ...
          let [n] = await Z.get(
            {
              ...
              select: [{ name: `oNC7XILjD`, type: `Identifier` }],
              where: {
          ...
          let [n] = await Z.get(
            {
              ...
              where: {
                left: { name: `oNC7XILjD`, type: `Identifier` },
                operator: `==`,
                right: { type: `LiteralValue`, value: e },
                type: `BinaryOperation`,
              },
        ...
        exports: {
          ...
          default: {
            ...
            annotations: {
              ...
              framerCollectionId: `kB5JQlUFw`,
              framerCollectionUtils: `1`,
              framerSlug: `oNC7XILjD`,
...
export {
  ...
  Xe as enumToDisplayNameFunctions,
  Qe as init_kB5JQlUFw,
  Ye as kB5JQlUFw_default,
  Ze as utils,
};
//# sourceMappingURL=kB5JQlUFw.NJETB578.mjs.map
